...
if __name__ == "__main__":
    ...
    links = lines.map(lambda urls: parseNeighborURLs(urls)).distinct().groupByKey().partitionBy(partitions)
    ...
    ranksDf.write.format("csv").save("hdfs://172.31.47.167:9000/part_output.csv")
